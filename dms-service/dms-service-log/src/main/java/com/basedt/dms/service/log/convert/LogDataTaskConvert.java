...
public interface LogDataTaskConvert extends BaseConvert<LogDataTask, LogDataTaskDTO> {

    LogDataTaskConvert INSTANCE = Mappers.getMapper(LogDataTaskConvert.class);

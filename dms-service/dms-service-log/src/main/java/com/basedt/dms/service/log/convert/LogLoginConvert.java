...
public interface LogLoginConvert extends BaseConvert<LogLogin, LogLoginDTO> {
    ...
    @Override
    @Mapping(target = "loginType", expression = "java(com.basedt.dms.service.sys.convert.DictVoConvert.INSTANCE.toDto(com.basedt.dms.common.constant.DictConstants.LOGIN_TYPE,entity.getLoginType()))")

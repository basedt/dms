...
public interface SysPrivilegeConvert extends BaseConvert<SysPrivilege, SysPrivilegeDTO> {

    SysPrivilegeConvert INSTANCE = Mappers.getMapper(SysPrivilegeConvert.class);

    @Override
    @Mapping(target = "privilegeName", expression = "java(com.basedt.dms.common.utils.I18nUtil.get(entity.getPrivilegeName()))")
    SysPrivilegeDTO toDto(SysPrivilege entity);

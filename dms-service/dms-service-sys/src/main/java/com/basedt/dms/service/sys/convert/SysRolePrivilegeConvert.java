...
public interface SysRolePrivilegeConvert extends BaseConvert<SysRolePrivilege, SysRolePrivilegeDTO> {

    SysRolePrivilegeConvert INSTANCE = Mappers.getMapper(SysRolePrivilegeConvert.class);
}

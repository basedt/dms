...
public interface DmsFileCatalogConvert extends BaseConvert<DmsFileCatalog, DmsFileCatalogDTO> {

    DmsFileCatalogConvert INSTANCE = Mappers.getMapper(DmsFileCatalogConvert.class);

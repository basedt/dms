...
public interface DmsWorkspaceConvert extends BaseConvert<DmsWorkspace, DmsWorkspaceDTO> {

    DmsWorkspaceConvert INSTANCE = Mappers.getMapper(DmsWorkspaceConvert.class);
